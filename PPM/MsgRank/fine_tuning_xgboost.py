# -*- coding: utf-8 -*-
"""Fine_Tuning von XGBoost.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1yEapxUm4iJ1xgRxkupeK17FT3usMp_MB
"""
...
#decide which features should be part of the dataframe
df=df[['LocID1','LocID2','LocID3','Gross','MsgRank','Speed','CheckIn', 'Net','SeqNr','Job']]
df.info()

#transform CheckIn to datetime|old version
...
#assign the features and target values
...
#save the feature importances of the model
...
#calculate the best feature set based on feature importance
...
#use the best selected features in the model
X=df[['LocID2' ,'LocID1']]
...
#repeat the last part of the code with different features to get the results shown in the overview table